...
class Environment {
   ...
   private function _main() {   
       ...
       'components' => array(                
                ...
                'user'=>array(                                         
                    ...
                    'stateKeyPrefix'=>'social_user_front_', //Should Change for Different Apps
                 ...
                 'session' => array(
                    'class' => 'CHttpSession',                    
                    'sessionName'=>'sess_id_front', //Should Change for Different Apps
                    'timeout' => 86400,
                 ),
   ...
   private function _development () {
          ...
          define('SITE_PATH','http://localhost/social/apps/web');
